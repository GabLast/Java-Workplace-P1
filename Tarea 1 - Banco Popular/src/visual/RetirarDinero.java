...
public class RetirarDinero extends JDialog {
	...
	public static void main(String[] args) {
		...
		try {
			RetirarDinero dialog = new RetirarDinero(null);
	 ...
	 * Create the dialog.
	 */
	public RetirarDinero(Banco banco) {
		setResizable(false);
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			{
				JLabel label = new JLabel("Cantidad a retirar: ");
